            ...
            <Dialog as="div" open={open} onClose={() => dispatch({ type: 'switchFolderUpload' })}>
              ...
              <div className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                <div className="flex min-h-screen items-center justify-center px-4">
                  ...
                  >
                    <Dialog.Panel as="div" className="panel my-24 w-3/6 overflow-hidden rounded-lg border-0 p-0 pb-6 text-black dark:text-white-dark md:w-3/6">
                      ...
                      <div className="px-5">
                        ...
                        <p className=" pt-5 text-sm font-semibold	text-gray-500">
                          You can select multiple files or a single folder to upload. If you upload a folder, file structure will be preserved. Files will be uploaded to {(path || []).join('/') + '/'}
                        </p>

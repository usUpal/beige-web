                    ...
                    <div className="flex h-full flex-col pb-16">
                        ...
                        <PerfectScrollbar className="relative h-full grow ltr:-mr-3.5 ltr:pr-3.5 rtl:-ml-3.5 rtl:pl-3.5">
                            <div className="space-y-1">
                                ...
                                >
                                    <div className="flex items-center">
                                        <svg className="shrink-0 rotate-180" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                                            ...
                                                            <div className="flex items-center whitespace-nowrap">
                                                                ...
                                                                <div className="ltr:mr-3 rtl:ml-3">
                                                                    <Tippy content="Important">
                                                                        <button
                                                                            type="button"
                                                                            className={`flex items-center enabled:hover:text-primary disabled:opacity-60 ${mail.isImportant ? 'text-primary' : ''}`}
                                                                            onClick={(e) => {
                                                                                e.stopPropagation();

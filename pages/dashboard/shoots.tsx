                                                ...
                                                <div className="mb-5">
                                                    ...
                                                    <div className="sm:flex">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="mb-10 p-5 pl-7 border border-solid border-[#C5965C] rounded-[20px] relative z-3 bg-white top-[-15px]">
                                                                <div className='absolute w-7 h-7 border border-solid border-[#C5965C] bg-white rotate-45 top-5 -left-3.5 bg-gradient-to-t from-[#C5965C] to-[rgba(197,150,92,0.1)]'></div>
                                                    ...
                                                    <div className="sm:flex">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="p-5 pl-7 border border-solid border-[#C5965C] rounded-[20px] relative z-3 bg-white top-[-15px]">
                                                                <div className='absolute w-7 h-7 border border-solid border-[#C5965C] bg-white rotate-45 top-5 -left-3.5 bg-gradient-to-t from-[#C5965C] to-[rgba(197,150,92,0.1)]'></div>
                                                                <h6 className="mb-2 font-semibold text-black text-2xl pb-2 border-b border-[#D9D9D9]">Trending Style</h6>
                                                                <p className="text-[16px] text-[#000000]">
                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.

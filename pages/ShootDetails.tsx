        ...
        <div className='grid grid-cols-1 md:grid md:grid-cols-2 gap-4 '>
          ...
          <div className="">
            ...
            <div className="mt-4 space-y-5">
              ...
              <div className="flex gap-1">
                <b className='inline-block w-[170px] '>Current Order Status: </b> <span>
          ...
          <div className=" ">
            ...
            <div className="mt-4 space-y-5">
              ...
              <div>
                <iframe className='w-full h-[400px]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7298.405077158279!2d90.38216309560319!3d23.84694062734523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c6a4cd8b5419%3A0x5ac8cf3c96294625!2sBaunia%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1723962056481!5m2!1sen!2sbd" loading="lazy"></iframe>
              </div>
            </div>
          </div>
          ...
          <div className=" ">
                  ...
                  <tr >
                    ...
                    <td className="border-b px-4 py-2">
                      <div className="flex justify-center">
                        <StatusBg>hello</StatusBg>
                      </div>
                    </td>
                    <td className="border-b px-4 py-2 text-right">
                      <div className="flex justify-center gap-2">
                        <button className={`rounded bg-red-500 p-1 text-white`}>
            ...
            <div className='mt-16'>
              <div className="lg:flex lg:flex-row flex flex-col space-x-2 mb-3 gap-2">
                <button className="rounded-lg bg-black px-3 py-2 font-sans font-semibold text-white w-full lg:w-[40%]">
                  Schedule Meeting
                </button>

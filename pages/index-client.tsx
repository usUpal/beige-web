                        ...
                        <div className="mb-5">
                            <div className="inline-block w-full">
                                ...
                                <div className="flex justify-between">
                                    <button type="button" className={`btn btn-warning ${activeTab3 === 1 ? 'hidden' : ''}`} onClick={() => setActiveTab3(activeTab3 === 3 ? 2 : 1)}>
                                        Back
                                    </button>
                                    <button type="button" className="btn btn-warning ltr:ml-auto rtl:mr-auto" onClick={() => setActiveTab3(activeTab3 === 1 ? 2 : 3)}>

                                ...
                                <form className="space-y-2 dark:text-white pb-5 w-11/12 mx-auto " onSubmit={handleSubmit(handleFormSubmit)}>
                                    ...
                                    <div className='flex flex-col md:flex-row justify-between items-center'>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative text-white-dark">
                                                <input {...register('rate')} id="Rate" type="number" placeholder="Enter Rate" className="form-input ps-3 placeholder:text-white-dark focus:border-[#E7D4BC] md:w-80 w-64" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col md:flex-row justify-between items-center">
                                        <div>
                                            ...
                                            <div className="relative text-white-dark">
                                                <input {...register('info')} id="info" type="text" placeholder="Enter AddOns Info" className="form-input ps-3 placeholder:text-white-dark focus:border-[#E7D4BC] md:w-80 w-64" />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select {...register('status')} id="status" className='ps-3 form-input  placeholder:text-white-dark focus:border-[#E7D4BC] md:w-80 w-64 '>
                                                <option value="1">Active</option>
                                                <option value="0">Inactive</option>
                                            </select>
                                        </div>

...
import errorImage from '../errors/errorImages//403not_found_image.svg'
import errorCircel from '../errors/errorImages/circel.png'
import errosShapeThree from '../errors/errorImages/errosShapeThree.svg'

function AccessDenied() {
  return (
    <div className='relative'>
      {/* <div className='h-[50%] w-[50%] m-auto pt-7'>
        <Image
          src={errorImage}
          alt="Access Denied"
          layout="responsive"
      ...
      <div className='h-screen  w-full m-auto flex flex-col justify-center'>
        <h1 className='text-[170px] font-bold text-center leading-[130px] mb-3'>404</h1>

        <h2 className='text-center text-4xl font-bold mt-5'>Page Not Found</h2>

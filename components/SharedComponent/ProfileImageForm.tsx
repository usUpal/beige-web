...
{/*  2xl:right-[32%] xl:right-[16%] md:right-[1px] opacity-0 */}
        <form onSubmit={handleSubmit(onSubmit)} className="rounded-md bg-white p-2 dark:border-[#191e3a] dark:bg-black group">
          <div className="h-32 w-32 rounded-full bg-[#02020281] absolute top-0 bottom-0 left-[88px] md:left-[41.5%] xl:left-[30px] 2xl:left-[31.5%] flex-col gap-0 justify-center items-center  transition-opacity
           duration-300 ease-out hover:opacity-100 hidden group-hover:block">

...
const IndexClient = () => {
  ...
  const orderName = () => {
    ...
    console.log("ok", contentVertical)
    ...
    console.log(contentVertical)
    const concateOrderName = `${userData?.name || 'Name'}'s ${contentVertical} ${type || 'Type'}`;
    console.log(concateOrderName)
  ...
  const onSubmit = async (data: any) => {
    ...
    } else if (JSON.parse(data.showDateTimes) == '') {
  ...
  //                             <div className="mb-2">
  //                               <label className="flex items-center">
  //                                 <input type="checkbox" className={`form-checkbox ${errors.content_vertical ? 'border-red-500' : ''}`} defaultValue="video" id="videoShootType" {...register('content_type',{
  //                                   required: 'Shoot Type Is Required'
  //                                 })} />
  //                                 <span className="text-white-dark">Videography</span>
  //                               </label>
  //                             </div>
  //                             {/* Photo */}
  //                             <div className="mb-2">
  ...
  //                                 <span className="text-white-dark">Photography</span>
  //                               </label>
  //                             </div>
  //                           </div>
  //                         </div>
  ...
  //                             Category
  //                           </label>
  //                           <select className={`form-select text-white-dark  ${errors.content_vertical ? 'border-red-500' : ''}`} id="content_vertical" defaultValue="SelectCategory"
  //                           {...register('content_vertical', {
  //                             required: 'Category is required',
  //                             validate: (value) => value !== 'SelectCategory' || 'Please select a valid category',
  //                           })}>
  ...
  //                               <input id="start_date_time" type="datetime-local" className="form-input" {...register('start_date_time')} onChange={handleChangeStartDateTime} required={dateTimes?.length === 0} />
  //                               {errors.start_date_time && <p className="text-danger">{errors?.start_date_time.message}</p>}
  //                             </div>
  ...
  //                                 Ending Date
  //                               </label>
  //                               <input id="end_date_time" type="datetime-local" className="form-input" {...register('start_date_time')} onChange={handleChangeEndDateTime} required={dateTimes?.length === 0} />

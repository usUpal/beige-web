                                    ...
                                    <li className='nav-item'>
                                        <Link href='/apps/shoots' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('Shoots')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/files' className='group'>
                                            <div className='flex items-center'>
                                                <svg width='24' height='24' viewBox='0 0 24 24' fill='none'
                                                     xmlns='http://www.w3.org/2000/svg'>
                                                    <path
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('Files')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/meetings' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('Meetings')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/chat' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('chat')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/transactions' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('Transactions')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/disputes' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('Disputes')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/settings' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('Settings')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/contacts' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('contacts')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link href='/apps/calendar' className='group'>
                                            <div className='flex items-center'>
                                                ...
                                                <span
                                                    className='text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark'>{t('calendar')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                </ul>

  ...
  return (
    <div>
      <ul className="flex space-x-2 rtl:space-x-reverse">
        ...
        <li className="text-black before:content-['/'] ltr:before:mr-2 rtl:before:ml-2 dark:text-slate-400">
          <span className="capitalize text-black dark:text-slate-400">{userData?.role}</span>
        </li>
      </ul>
      ...
      <div className="pt-5">
        <div className="mb-6 grid gap-6 xl:grid-cols-3">
          <div className="panel h-full xl:col-span-2">
            <div className="mb-5 flex items-center justify-between dark:text-slate-400">
              ...
              <div className="dropdown">
                <Dropdown offset={[0, 1]} placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`} button={allSvgs.revenueDayWkMonthSortBtnSvg}>
                  <ul>
                    <li>
                      <button type="button" className="text-black dark:text-slate-400">
                        Weekly
                      </button>
                    </li>
                    <li>
          ...
          <div className="panel h-full">
            <div className="mb-5 flex items-center">
              <h5 className="text-lg font-semibold dark:text-slate-400">Shoots By Category</h5>
            </div>
            <div>
              <div className="rounded-lg bg-white dark:bg-black">
                {isMounted ? (
                  ...
                  <div className="grid min-h-[325px] place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] ">
                    <span className="inline-flex h-5 w-5 animate-spin rounded-full  border-2 border-black !border-l-transparent dark:border-white dark:text-slate-400"></span>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-1">
          <div className="panel h-full p-0">
            <div className="absolute flex w-full items-center justify-between p-5">
              ...
              <h5 className="text-2xl font-semibold ltr:text-right rtl:text-left dark:text-slate-400">
                3,192

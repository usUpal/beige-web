...
function middleware(request) {
    ...
    if (typeof userData === "object") {
        ...
        if (request.nextUrl.pathname.startsWith("/cp") && userRole !== "cp" || request.nextUrl.pathname.startsWith("/client") && userRole !== "user" || request.nextUrl.pathname.startsWith("/manager") && userRole !== "manager") {
            return NextResponse.redirect(new URL("/", request.url));
        }
    }
}

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=%2Fhome%2Fforge%2Fbeige.luminousdemo.com&matchers=&preferredRegion=&middlewareConfig=e30%3D!
